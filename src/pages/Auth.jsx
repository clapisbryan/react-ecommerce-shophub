      ...
      <div className="container">
        <div className="auth-container">
          ...
          <div className="auth-switch">
            {mode === "signup" ? <p>Already have an account? <span className="auth-link" onClick={() => setMode("login")}>Login</span></p> : <p>Don't have an account? <span className="auth-link" onClick={() => setMode("signup")}>Signup</span></p>}
          </div>
        </div>
      </div>
